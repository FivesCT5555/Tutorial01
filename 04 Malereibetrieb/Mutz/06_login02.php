...
if(count($_POST)>0) {
	...
	if($_POST["E"]==$email_korrekt && $_POST["P"]==$pwd_korrekt) {
		...
		header("Location: 06_geschuetzt.php"); //ab diesem Zeitpunkt beendet der Server die Verarbeitung DIESES Dokumentes und widmet sich der Verarbeitung von 05_geschuetzt.php
	}
	else {
